...
">
    ...
    <span style="position: relative;display: inline-block;vertical-align: middle;left:{{it && it.left ? it.left : 0}}px;top:{{it && it.top ? it.top : 0}}px;vertical-align: middle;" w-class="text_player_coin_num">{{it.text[0]}}
