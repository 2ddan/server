...
<div style="width:{{it.width || 0}}px;height:{{it.height || 0}}px;text-align:{{it.align || 'center'}};">
    ...
    {{else}}
    <pi-ui-html style="margin-left:{{it.marginLeft || 0}}px;position: absolute;width: 100%;height: 100%;left: {{it.left || 0}}px;line-height:{{it.height}}px">{{it.text === 0 ? 0 : (it.text ? it.text : '')}}</pi-ui-html>
    {{end}}
