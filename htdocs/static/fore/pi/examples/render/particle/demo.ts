...
const init = () => {
     let sceneJson = toJson(butil.utf8Decode(configMap.get("examples/render/res/scene/cubep.scene")));
    ...
    let psConfig = {
        ...
        emission: {
            ...
            rateOverDistanceMultiplier: 1.0,

            rateOverTime: {
                mode: PSCurveMode.Constant,
                constant: 100.0
            },
            rateOverTimeMultiplier: 1.0,
