...
export interface ReadNext {
	(bb: BinBuffer, type: number, len?: number): BinCode | Array<BinCode>;
}
export interface WriteNext {
	(bb: BinBuffer, o: BinCode): void;
}
/**
 * 二进制可序列化对象
 * @example
 ...
 * @example
 */
export const writeArray = (o: Array<any>, bb: BinBuffer, writeNext: WriteNext) => {
