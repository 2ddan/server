 ...
 */
export class Euler {
    x: number;              // 沿着x轴的角度，单位：弧度
    y: number;              // 沿着y轴的角度，单位：弧度
    z: number;              // 沿着z轴的角度，单位：弧度    
    order: RotationOrder;   // 默认XYZ

    static _m: Matrix4;

    static _q: Quaternion;
     ...
     * @description 从三维向量构建
     */
    setFromVector3(v: Vector3, order: RotationOrder) {
