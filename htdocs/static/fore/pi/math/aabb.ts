...
export class AABB {
    ...
    setFromCenterAndSize(center: Vector3, size: Vector3) {
        ...
        let halfSize = _v1.copy(size).multiplyScalar(0.5);
    ...
    distanceToPoint(point: Vector3) {
        ...
        let clampedPoint = _v1.copy(point).clamp(this.min, this.max);
     ...
     * @description 取包围球
     */
    getBoundingSphere(optionalTarget?: Sphere) {
        if (_v1 === undefined) _v1 = new Vector3();
