    ...
    <div style="position:absolute;left:0;right:0;top:75px;margin-top:-75px;bottom:0;">
      ...
      <div style="position:absolute;margin-left:0px;width:100%;bottom:35px;padding:10px 0;text-align:center;height:45px;z-index: 1;">
            <div style="position:absolute;top:7px;width:100%;text-align:center">
                  ...
                  <app-widget-btn-menu on-tap='gotoMenu("{{v.func}}")' style="position:relative;display:inline-block;margin-right:20px;">
                        {"guide":{{guide_btn}},"icon":{{v.icon}},"text":{{v.text}},"width":{{v.text == "神兵"?73:68}},"height":{{v.text == "神兵"?73:68}},"bottom":-2,"fontSize":20,"tip_keys":{{v.tip_keys}} }
                  </app-widget-btn-menu>
                  {{end}}
                  {{if v.text == "时装" }}
