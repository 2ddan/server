<div maxId="61" test="test" style="position: absolute;width: 100%;height: 100%" w-sid="2">
    <div w-class="3" w-sid="3">
        ...
        <div w-class="12" w-sid="12">
            ...
            <widget  on-tap="DismissGang" w-class="13" w-tag="app_a-widget-btn-rect" w-sid="13">
                {"class":"default","fontsize":18,"color":"#fdedd7;","text":"解 散","width":84,"height":32} 
            </widget>

            <widget on-tap='closeCover' w-class="14" w-tag="app_a-widget-btn-rect" w-sid="14">
                {"class":"hl","fontsize":18,"color":"","text":"取 消","width":84,"height":32} 
            </widget>
