...
<div style="position: absolute;width: 100%;height: 100%;z-index:2;left: 50%;margin-left: -270px;">
    ...
    <div w-class="4" w-sid="4" style="bottom:10px;height:55px;">
		<div w-class="5" w-sid="5">
            ...
            <app_a-widget-pic_text-pic_text style="width:143px;height:28px;position: absolute;color: #ffd8a6;font-size: 16px;">{"icon":"resource_bar","width":143,"height":28,"align":"left","marginLeft":"10px","text":{{"挑战次数：" + Cfg.publicboss_config.publicboss_config.fight_times + "/" + it1.total_count}}} 
    ...
    <div w-class="13" class="scroll_box_v" layout="scroll" w-sid="13" style="position: absolute;width: 492px;height: 630px;left: 50%;top: 65px;color: #fff;margin-left: -247px;">
        {{for i,v of it1.initData.boss_info}}
            ...
            <div style="width: 448px;height: 127px;position: relative;left: 0;right: 0;margin: 0 auto;margin-bottom: 10px;">
                ...
                <img src="../images/boss_head_{{i - 0 + 1}}.png" style="position:absolute;left:0px;top:0px;z-index:1" />
                ...
                <app_a-widget-pic_text-pic_text style="top:71px;position:absolute;left:13px;color: #fde7ca;font-family:mnjsh;z-index: 1;">
                    {"icon":"boss_name_bg","width":108,"height":27,"align":"center","marginLeft":0,"text":{{it1.boss_base[i].name}},"textCfg":"","space":2,"fontSize":18,"top":0,"left":0} 
                </app_a-widget-pic_text-pic_text>

                {{let percent = it1.initData.boss_info[i][2] / it1.boss_base[i].maxHp}}
                ...
                <span style="position: absolute;left: 130px;top: 2px;color:#fde7ca;font-size:18px">
                    掉落: 
                ...
                <div style="width:auto;height:95px;position:absolute;left: 125px;top: 30px;">
                    {{for m,n of _award}}
                        ...
                        <app_a-widget-prop-base style="position:relative;display:inline-block;margin-right:5px;font-size: 18px;">
                ...
                {{if it1.player.level >= v[1] && v[2] > 0 && it1.initData.fight_info[v[4]] < publicboss_base[v[0]].map_player}}
                    <span style="position: absolute;right: 8px;top: 5px;z-index: 1;width: 100px;text-align: center;font-size: 18px;color: #fde7ca;">{{"争夺:" + it1.initData.fight_info[v[4]]}}</span>
                    <app_a-widget-btn-rect style="position: absolute;right: 10px;top: 40px;" on-tap='startFight("{{[boss_id,it1.initData.boss_info[i][4]]}}")'>
                ...
                {{elseif it1.initData.fight_info[v[4]] >= publicboss_base[v[0]].map_player}}
                    <span style="position: absolute;right: 8px;top: 5px;z-index: 1;width: 100px;text-align: center;font-size: 18px;color: #fde7ca;">{{"争夺:" + publicboss_base[v[0]].map_player}}</span>
                    <app_a-widget-btn-rect style="position: absolute;right: 10px;top: 40px;" on-tap="lineUp({{v[4]}})">
                        {"class":"hl","fontsize":24,"color":"#fdedd7;","text":"挑  战","width":95,"height":41,"marginLeft":0} 
                    </app_a-widget-btn-rect>
