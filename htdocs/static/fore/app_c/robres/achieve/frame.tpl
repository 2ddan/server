...
<div style="width:450px;height:148px;position:relative;margin-bottom: 20px;">
    ...
    <app_a-widget-text-text style="position:absolute;top:10px;left:18px;">
        {"text":{{text}},"fontSize":26,"textCfg":"iconCircle" }
    ...
    <div data-desc="奖励" style="position: absolute;top:55px;left:11px;height:60px;width:295px;">
        ...
        <div style="position:relative;width:60px;height:60px;margin:0px 5px;display:inline-block;color:#ffffff;">
            <widget w-tag="app_a-widget-prop-base" on-tap="propInfoShow({{n[0]}})">
                {"width":60,"height":60,"prop":{{prop}} ,"url":{{url}},"count":{{n[1]}},"name":{{prop.name}},"top":22,"right":6,"effect":{{prop.effect}}} 
            </widget>
        </div>
        {{end}}
        {{end}}							
    ...
    {{if !it.get}}
    <app_a-widget-pic_text-pic_text style="top:46px;right:23px;position: absolute;">
        {"icon":"text_get_1","width":94,"height":60,"marginLeft":3}
    </app_a-widget-pic_text-pic_text>
    {{elseif it.get == 2}}
    <div style="position:absolute;top:46px;right:23px;font-size:16px;height:45px;width:116px;text-align:center;">
