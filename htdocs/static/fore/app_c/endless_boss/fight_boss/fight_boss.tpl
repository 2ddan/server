<div style="position:absolute;left:0;top:0;width:100%;z-index:2;bottom:0px;">
    ...
    <app-scene-base-scene>{"name":"endless_boss","newscene":{{it1.map_cfg["endless_boss"]}} }</app-scene-base-scene>
    ...
    {{let end_time = it1.endless_boss_base.fight_time_limit * 1000 + now}}
    {{if it1.fight_ing}}
    <app-widget-cdtime ev-countdownend="timeEnd1" style="position: absolute;top: 115px;font-size: 16px;width: 108px;right: 50%;margin-right: -270px;text-align:center;color:#78f300;">{cd_time:{{end_time}},"now_time":{{now}} }</app-widget-cdtime>
    {{end}}
