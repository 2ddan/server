...
<div style="position:absolute;top:0;left:0;z-index:2;width:100%;height:100%;">
    ...
    <div style="width:100%;position:absolute;height:auto;left:50%;top:100px;margin-left:-273px;overflow:hidden;z-index:2;bottom: 90px;">
        <div style="position:absolute;top:3px;left:30px;z-index:3">
            {{let arr = b ? ["紫色","橙色","红色"] : ["紫色","橙色"]}} 
            {{for i,v of arr}} 
                {{let quality = i-0+4}}
        ...
        <div class="bg_1" style="position:absolute;width:492px;height:auto;top:48px;left:27px;bottom: 20px;"></div>

        <div style="position:absolute;width:492px;height:auto;top:48px;left:27px;bottom: 34px;">
            <div scroller="1" style="box-sizing:border-box;width:105%;height:100%;overflow-y: auto; overflow-x: hidden;padding-top:15px">
                ...
                <div style="height: 127px;position: relative;width:447px;margin-bottom:10px;left:20px">
                    ...
                    <div style="position:absolute;left:16px;top:15px;width:76px;height:76px;">
                        <app_a-widget-prop-base style="width:76px;height:76px;">
                            {"prop":{{n}},"url":{{it1.Pi.pictures[n.icon]}},"count":"none","hidden_name":1,"type":{{v.type}}}
