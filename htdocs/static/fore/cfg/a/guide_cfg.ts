...
let s:any = {};
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["9"].music = "music-equip_gem";guide_cfg["9"].count = 1;guide_cfg["9"].trigger = `open_fun.id==${function_open.equip_gem.id-1}&&wild.wild_max_mission>=${function_open.equip_gem.stage_id}&&wild.wild_task_num>=0`;guide_cfg["9"].widget = "app_b-wild-wild";guide_cfg["9"].guide_text = "开放宝石";guide_cfg["9"].fun_key = "equip_gem";guide_cfg["9"].need = "1";guide_cfg["9"].need_map = "1";guide_cfg["9"].next_guide = 44;
    s = {};
    guide_cfg["9"] = guide_cfg["9"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["10"].music = "music-magic_activate";guide_cfg["10"].count = 1;guide_cfg["10"].trigger = `open_fun.id==${function_open.magic_activate.id-1}&&wild.wild_max_mission>=${function_open.magic_activate.stage_id}&&wild.wild_task_num>=0`;guide_cfg["10"].widget = "app_b-wild-wild";guide_cfg["10"].guide_text = "开放神兵";guide_cfg["10"].fun_key = "magic_activate";guide_cfg["10"].need = "1";guide_cfg["10"].need_map = "1";guide_cfg["10"].next_guide = 41;
    s = {};
    guide_cfg["10"] = guide_cfg["10"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["11"].music = "music-pet";guide_cfg["11"].count = 1;guide_cfg["11"].trigger = `open_fun.id==${function_open.pet.id-1}&&wild.wild_max_mission>=${function_open.pet.stage_id}&&wild.wild_task_num>=0`;guide_cfg["11"].widget = "app_b-wild-wild";guide_cfg["11"].guide_text = "开放宠物";guide_cfg["11"].fun_key = "pet";guide_cfg["11"].need = "1";guide_cfg["11"].need_map = "1";guide_cfg["11"].next_guide = 45;
    s = {};
    guide_cfg["11"] = guide_cfg["11"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["13"].music = "music-daily_fb";guide_cfg["13"].count = 1;guide_cfg["13"].trigger = `open_fun.id==${function_open.daily_fb.id-1}&&wild.wild_max_mission>=${function_open.daily_fb.stage_id}&&wild.wild_task_num>=0`;guide_cfg["13"].widget = "app_b-wild-wild";guide_cfg["13"].guide_text = "开放材料副本";guide_cfg["13"].fun_key = "daily_fb";guide_cfg["13"].need = "1";guide_cfg["13"].need_map = "1";guide_cfg["13"].next_guide = 51;
    s = {};
    guide_cfg["13"] = guide_cfg["13"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["14"].music = "music-arena";guide_cfg["14"].count = 1;guide_cfg["14"].trigger = `open_fun.id==${function_open.arena.id-1}&&wild.wild_max_mission>=${function_open.arena.stage_id}&&wild.wild_task_num>=0`;guide_cfg["14"].widget = "app_b-wild-wild";guide_cfg["14"].guide_text = "开放竞技场";guide_cfg["14"].fun_key = "arena";guide_cfg["14"].need = "1";guide_cfg["14"].need_map = "1";guide_cfg["14"].next_guide = 47;
    s = {};
    guide_cfg["14"] = guide_cfg["14"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["16"].music = "music-gang";guide_cfg["16"].count = 1;guide_cfg["16"].trigger = `open_fun.id==${function_open.gang.id-1}&&wild.wild_max_mission>=${function_open.gang.stage_id}&&wild.wild_task_num>=0`;guide_cfg["16"].widget = "app_b-wild-wild";guide_cfg["16"].guide_text = "开放门派";guide_cfg["16"].fun_key = "gang";guide_cfg["16"].need = "1";guide_cfg["16"].need_map = "1";
    s = {};
    guide_cfg["16"] = guide_cfg["16"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["17"].music = "music-equip_fb";guide_cfg["17"].count = 1;guide_cfg["17"].trigger = `open_fun.id==${function_open.equip_fb.id-1}&&wild.wild_max_mission>=${function_open.equip_fb.stage_id}&&wild.wild_task_num>=0`;guide_cfg["17"].widget = "app_b-wild-wild";guide_cfg["17"].guide_text = "开放装备副本";guide_cfg["17"].fun_key = "equip_fb";guide_cfg["17"].need = "1";guide_cfg["17"].need_map = "1";guide_cfg["17"].next_guide = 48;
    s = {};
    guide_cfg["17"] = guide_cfg["17"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["18"].music = "music-random_boss";guide_cfg["18"].count = 1;guide_cfg["18"].trigger = `open_fun.id==${function_open.random_boss.id-1}&&wild.wild_max_mission>=${function_open.random_boss.stage_id}&&wild.wild_task_num>=0`;guide_cfg["18"].widget = "app_b-wild-wild";guide_cfg["18"].guide_text = "开放宝箱守卫";guide_cfg["18"].fun_key = "random_boss";guide_cfg["18"].need = "1";guide_cfg["18"].need_map = "1";
    s = {};
    guide_cfg["18"] = guide_cfg["18"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["19"].music = "music-tower";guide_cfg["19"].count = 1;guide_cfg["19"].trigger = `open_fun.id==${function_open.tower.id-1}&&wild.wild_max_mission>=${function_open.tower.stage_id}&&wild.wild_task_num>=0`;guide_cfg["19"].widget = "app_b-wild-wild";guide_cfg["19"].guide_text = "开放天庭秘境";guide_cfg["19"].fun_key = "tower";guide_cfg["19"].need = "1";guide_cfg["19"].need_map = "1";guide_cfg["19"].next_guide = 49;
    s = {};
    guide_cfg["19"] = guide_cfg["19"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["20"].music = "music-equip_star";guide_cfg["20"].count = 1;guide_cfg["20"].trigger = `open_fun.id==${function_open.equip_star.id-1}&&wild.wild_max_mission>=${function_open.equip_star.stage_id}&&wild.wild_task_num>=0`;guide_cfg["20"].widget = "app_b-wild-wild";guide_cfg["20"].guide_text = "开放装备升星";guide_cfg["20"].fun_key = "equip_star";guide_cfg["20"].need = "1";guide_cfg["20"].need_map = "1";
    s = {};
    guide_cfg["20"] = guide_cfg["20"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["21"].music = "music-instance_fb";guide_cfg["21"].count = 1;guide_cfg["21"].trigger = `open_fun.id==${function_open.instance_fb.id-1}&&wild.wild_max_mission>=${function_open.instance_fb.stage_id}&&wild.wild_task_num>=0`;guide_cfg["21"].widget = "app_b-wild-wild";guide_cfg["21"].guide_text = "开放九幽幻境";guide_cfg["21"].fun_key = "instance_fb";guide_cfg["21"].need = "1";guide_cfg["21"].need_map = "1";guide_cfg["21"].next_guide = 50;
    s = {};
    guide_cfg["21"] = guide_cfg["21"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["22"].music = "music-gest";guide_cfg["22"].count = 1;guide_cfg["22"].trigger = `open_fun.id==${function_open.gest.id-1}&&player.level>=${function_open.gest.level_limit}`;guide_cfg["22"].widget = "app_b-wild-wild";guide_cfg["22"].guide_text = "开放阵法";guide_cfg["22"].fun_key = "gest";guide_cfg["22"].need = "1";
    s = {};
    guide_cfg["22"] = guide_cfg["22"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["23"].music = "music-gest_fb";guide_cfg["23"].count = 1;guide_cfg["23"].trigger = `open_fun.id==${function_open.gest_fb.id-1}&&player.level>=${function_open.gest_fb.level_limit}`;guide_cfg["23"].widget = "app_b-wild-wild";guide_cfg["23"].guide_text = "开放心法奇遇";guide_cfg["23"].fun_key = "gest_fb";guide_cfg["23"].need = "1";
    s = {};
    guide_cfg["23"] = guide_cfg["23"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["24"].music = "music-equip_red_forge";guide_cfg["24"].count = 1;guide_cfg["24"].trigger = `open_fun.id==${function_open.equip_red_forge.id-1}&&player.level>=${function_open.equip_red_forge.level_limit}`;guide_cfg["24"].widget = "app_b-wild-wild";guide_cfg["24"].guide_text = "开放神装锻造";guide_cfg["24"].fun_key = "equip_red_forge";guide_cfg["24"].need = "1";
    s = {};
    guide_cfg["24"] = guide_cfg["24"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["25"].music = "music-equip_red_wash";guide_cfg["25"].count = 1;guide_cfg["25"].trigger = `open_fun.id==${function_open.equip_red_wash.id-1}&&player.level>=${function_open.equip_red_wash.level_limit}`;guide_cfg["25"].widget = "app_b-wild-wild";guide_cfg["25"].guide_text = "开放神装洗练";guide_cfg["25"].fun_key = "equip_red_wash";guide_cfg["25"].need = "1";
    s = {};
    guide_cfg["25"] = guide_cfg["25"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["27"].music = "music-soul";guide_cfg["27"].count = 1;guide_cfg["27"].trigger = `open_fun.id==${function_open.soul.id-1}&&wild.wild_max_mission>=${function_open.soul.stage_id}&&wild.wild_task_num>=0`;guide_cfg["27"].widget = "app_b-wild-wild";guide_cfg["27"].guide_text = "开放龙魂";guide_cfg["27"].fun_key = "soul";guide_cfg["27"].need = "1";guide_cfg["27"].need_map = "1";
    s = {};
    guide_cfg["27"] = guide_cfg["27"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["28"].music = "music-weapon_soul";guide_cfg["28"].count = 1;guide_cfg["28"].trigger = `open_fun.id==${function_open.weapon_soul.id-1}&&player.level>=${function_open.weapon_soul.level_limit}`;guide_cfg["28"].widget = "app_b-wild-wild";guide_cfg["28"].guide_text = "开放赋灵";guide_cfg["28"].fun_key = "weapon_soul";guide_cfg["28"].need = "1";
    s = {};
    guide_cfg["28"] = guide_cfg["28"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["29"].music = "music-equip_level";guide_cfg["29"].count = 1;guide_cfg["29"].trigger = `open_fun.id==${function_open.equip_level.id-1}&&wild.wild_max_mission>=${function_open.equip_level.stage_id}&&wild.wild_task_num>=0`;guide_cfg["29"].widget = "app_b-wild-wild";guide_cfg["29"].guide_text = "开放装备强化";guide_cfg["29"].fun_key = "equip_level";guide_cfg["29"].need = "1";guide_cfg["29"].need_map = "1";guide_cfg["29"].next_guide = 42;
    s = {};
    guide_cfg["29"] = guide_cfg["29"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["30"].music = "music-reclaim";guide_cfg["30"].count = 1;guide_cfg["30"].trigger = `open_fun.id==${function_open.reclaim.id-1}&&wild.wild_max_mission>=${function_open.reclaim.stage_id}&&wild.wild_task_num>=0`;guide_cfg["30"].widget = "app_b-wild-wild";guide_cfg["30"].guide_text = "开放熔炼";guide_cfg["30"].fun_key = "reclaim";guide_cfg["30"].need = "1";guide_cfg["30"].need_map = "1";guide_cfg["30"].next_guide = 43;
    s = {};
    guide_cfg["30"] = guide_cfg["30"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["31"].music = "music-store";guide_cfg["31"].count = 1;guide_cfg["31"].trigger = `open_fun.id==${function_open.store.id-1}&&wild.wild_max_mission>=${function_open.store.stage_id}`;guide_cfg["31"].widget = "app_b-wild-wild";guide_cfg["31"].guide_text = "开放商店";guide_cfg["31"].fun_key = "store";guide_cfg["31"].need = "1";guide_cfg["31"].need_map = "1";
    s = {};
    guide_cfg["31"] = guide_cfg["31"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["32"].music = "music-money_tree";guide_cfg["32"].count = 1;guide_cfg["32"].trigger = `open_fun.id==${function_open.money_tree.id-1}&&wild.wild_max_mission>=${function_open.money_tree.stage_id}`;guide_cfg["32"].widget = "app_b-wild-wild";guide_cfg["32"].guide_text = "开放摇钱树";guide_cfg["32"].fun_key = "money_tree";guide_cfg["32"].need = "1";guide_cfg["32"].need_map = "1";
    s = {};
    guide_cfg["32"] = guide_cfg["32"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["34"].music = "music-investment";guide_cfg["34"].count = 1;guide_cfg["34"].trigger = `open_fun.id==${function_open.investment.id-1}&&wild.wild_max_mission>=${function_open.investment.stage_id}`;guide_cfg["34"].widget = "app_b-wild-wild";guide_cfg["34"].guide_text = "开放成长基金";guide_cfg["34"].fun_key = "investment";guide_cfg["34"].need = "1";guide_cfg["34"].need_map = "1";
    s = {};
    guide_cfg["34"] = guide_cfg["34"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["35"].music = "music-sevendays";guide_cfg["35"].count = 1;guide_cfg["35"].trigger = `open_fun.id==${function_open.sevendays.id-1}&&wild.wild_max_mission>=${function_open.sevendays.stage_id}&&wild.wild_task_num>=0`;guide_cfg["35"].widget = "app_b-wild-wild";guide_cfg["35"].guide_text = "七日活动";guide_cfg["35"].fun_key = "sevendays";guide_cfg["35"].need = "1";guide_cfg["35"].need_map = "1";guide_cfg["35"].next_guide = 52;
    s = {};
    guide_cfg["35"] = guide_cfg["35"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["52"].count = 1;guide_cfg["52"].trigger = `open_fun.id>=${function_open.sevendays.id}&&sevendays&&!sevendays.record[db.sevendays.loginDay]&&!wild.flagHitBoss&&sevendays.loginDay==db.sevendays.nowDay`;guide_cfg["52"].widget = "app_b-wild-wild";guide_cfg["52"].guide_text = "七日活动";
    s = {};
    guide_cfg["52"] = guide_cfg["52"] || [];
    s.type = "force";s.name = "gotoSevendaysAct";
    s.purpose = (db) => {
        return db.sevendays.record[db.sevendays.loginDay];
    };
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["53"].music = "music-skill";guide_cfg["53"].count = 1;guide_cfg["53"].trigger = `open_fun.id==${function_open.skill2.id-1}&&player.level>=${function_open.skill2.level_limit}`;guide_cfg["53"].widget = "app_b-wild-wild";guide_cfg["53"].guide_text = "开放技能2";guide_cfg["53"].fun_key = "skill2";guide_cfg["53"].next_guide = 8;
    s = {};
    guide_cfg["53"] = guide_cfg["53"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["54"].music = "music-skill";guide_cfg["54"].count = 1;guide_cfg["54"].trigger = `open_fun.id==${function_open.skill3.id-1}&&player.level>=${function_open.skill3.level_limit}`;guide_cfg["54"].widget = "app_b-wild-wild";guide_cfg["54"].guide_text = "开放技能3";guide_cfg["54"].fun_key = "skill3";
    s = {};
    guide_cfg["54"] = guide_cfg["54"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["55"].music = "music-skill";guide_cfg["55"].count = 1;guide_cfg["55"].trigger = `open_fun.id==${function_open.skill4.id-1}&&player.level>=${function_open.skill4.level_limit}`;guide_cfg["55"].widget = "app_b-wild-wild";guide_cfg["55"].guide_text = "开放技能4";guide_cfg["55"].fun_key = "skill4";
    s = {};
    guide_cfg["55"] = guide_cfg["55"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
    ...
    s.type = "force";s.widget = "app_b-wild-wild";guide_cfg["56"].count = 1;guide_cfg["56"].trigger = `open_fun.id==${function_open.public_boss.id-1}&&wild.wild_max_mission>=${function_open.public_boss.stage_id}&&wild.wild_task_num>=0`;guide_cfg["56"].widget = "app_b-wild-wild";guide_cfg["56"].guide_text = "开放荒野降魔";guide_cfg["56"].fun_key = "public_boss";guide_cfg["56"].need = "1";guide_cfg["56"].need_map = "1";
    s = {};
    guide_cfg["56"] = guide_cfg["56"] || [];
    s.type = "force";s.name = "fun_open";
    s.purpose = (db) => {
