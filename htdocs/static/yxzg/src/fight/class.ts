import effect from "../app/scene/art_cfg/effect";
...
export class Buff{
	...
	//处理卡牌-card([from,to,from_random?,to_select?,formula(卡牌条件["属性名","属性值",...]),to_number,from_number,id,[addbuff,..(添加到抽出来的卡牌)]]) 获得卷轴-get_scroll([id,number])
