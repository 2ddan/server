...
export const create = () => {
	...
	// 上次花费时间，本次帧时间，帧次数
	let frameCost = 0, frameTime = 0, frameCount = 0;
	// 默认的间隔时间
	...
	let curStat = { time: 0, frame: { count: 0, cost: 0, slowIndex: 0, slowCost: 0 }, call: { count: 0, cost: 0, slowIndex: 0, slowCost: 0, slowFuncIndex: 0, slowFuncCost: 0, slowFunc: null } };
	// 上次统计
	let lastStat = { time: 0, frame: { count: 0, cost: 0, slowIndex: 0, slowCost: 0 }, call: { count: 0, cost: 0, slowIndex: 0, slowCost: 0, slowFuncIndex: 0, slowFuncCost: 0, slowFunc: null } };
	 ...
	 * @example
	 */
	frame.setPermanent = (func: Function, args?: Array<any>) => {
	 ...
	 * @example
	 */
	frame.setBefore = (func: Function, args?: Array<any>) => {
	 ...
	 * @example
	 */
	frame.setAfter = (func: Function, args?: Array<any>) => {
	 ...
	 * @example
	 */
	frame.setNext = (func: Function, args?: Array<any>) => {
