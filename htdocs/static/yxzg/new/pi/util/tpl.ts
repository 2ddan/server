...
export const VARNAME = '_cfg, it, it1, it2, it3, it4, it5, it6, it7, it8, it9';
...
export const toFunComplete = (func: Function, path?: string) => {
	try {
		return func(toString, commonjs ? commonjs.relativeGet : null, hash, path, convertEntity, calAttrHash, calTextHash, addJson, installText, addText, chFunc);
	} catch (e) {
