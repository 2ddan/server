...
pi_modules['pi/ui/html.tpl'] = exports;





export const tpl = (function(_cfg,it,it1){let $t, $n;$t=$n;{let $p = $t;let $n = {"a":{},"e":{},"eH":0,"tg":"div","si":0};$n.cd=[];$n["aS"] = 1;$n["aH"] = 2056551821;{let attrvalue = "";attrvalue = it;$n["a"]["w-inner"] = attrvalue;}$n["aH"] = _j($n["aH"], _c($n["a"]["w-inner"]));_i($n);_h($n);return $n;} });
