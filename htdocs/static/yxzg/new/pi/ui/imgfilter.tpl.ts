...
const _path = 'pi/ui/imgfilter.tpl';
...
pi_modules['pi/ui/imgfilter.tpl'] = exports;





export const tpl = (function(_cfg,it,it1){let $t, $n;$t=$n;{let $p = $t;let $n = {"a":{},"e":{},"eH":0,"tg":"img","si":0};$n.cd=[];$n["aS"] = 1;$n["aH"] = 2535865677;{let attrvalue = "";attrvalue = it.url||'';$n["a"]["src"] = attrvalue;}$n["aH"] = _j($n["aH"], _c($n["a"]["src"]));_i($n);_h($n);return $n;} });
