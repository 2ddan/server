...
pi_modules['pi/ui/tip.tpl'] = exports;





export const tpl = (function(_cfg,it,it1){let $t, $n;$t=$n;{let $p = $t;let $n = {"a":{},"e":{},"eH":0,"tg":"div","si":0};$n.cd=[];$n["aH"] = 1526069159;$n["wc"]="tip_point";{let attrvalue = "";attrvalue += "position:absolute;pointer-events:none;display:";if(it.show){attrvalue += "block";}else{attrvalue += "none";}attrvalue += ";";attrvalue=_s(attrvalue);$n["s"]=attrvalue;$n["sS"]=Object.keys(attrvalue).length;$n["sH"]=_d(attrvalue);}_i($n);_h($n);return $n;} });
