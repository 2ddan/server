...
pi_modules['pi/ui/ansi.tpl'] = exports;





export const tpl = (function(_cfg,it,it1){let $t, $n;$t=$n;{let $p = $t;let $n = {"a":{},"e":{},"eH":0,"tg":"div","si":0};$n.cd=[];$n["aH"] = 0;$t=$n;{let $p = $t;let $n = {"a":{},"e":{},"eH":0,"tg":"imgtext$","si":1};$n.cs = false;$n.ch = null;$n["aH"] = 0;$t=$n;{let $p = $t;let $n = {};//jpair pre
			
				$t=$n;{let $p = $t;	$t=$n;{let $p = $t;let $n = {};//jpair pre
			
				{
					let jvalue = "";
					jvalue = "!#$%'()*+,-./0123456789:;=?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[]^abcdefghijklmnopqrstuvwxyz{|}~";
			//jpair suf
