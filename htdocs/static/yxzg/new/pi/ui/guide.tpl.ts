...
pi_modules['pi/ui/guide.tpl'] = exports;





export const tpl = (function(_cfg,it,it1){let $t, $n;$t=$n;{let $p = $t;let $n = {"a":{},"e":{},"eH":0,"tg":"div","si":0};$n.cd=[];$n.cH =2946814719;$n["aS"] = 1;$n["eS"] = 1;$n["aH"] = 3757922498;$n["e"]["pointerclick"]="guide";
        $n["eH"]=_j($n["eH"],2896721711);$n["a"]["w-ev-tap"] = "{'stop':false}";{$n["s"]={"c5":1,"a0":[0,0],"d8":[0,0],"e8":[1,100],"y":[1,100],"f0":111};$n["sH"]=2000988168;$n["sS"]=6;}_i($n);return $n;} });
