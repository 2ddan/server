...
pi_modules['pi/ui/langImg.tpl'] = exports;





export const tpl = (function(_cfg,it,it1){let $t, $n;$t=$n;{let $p = $t;let $n = {"a":{},"e":{},"eH":0,"tg":"img","si":0};$n.cd=[];$n["aS"] = 1;$n["aH"] = 1848122660;{let attrvalue = "";attrvalue += it[it1];attrvalue += "";$n["a"]["src"] = attrvalue;}$n["aH"] = _j($n["aH"], _c($n["a"]["src"]));_i($n);_h($n);return $n;} });
