 ...
 * 
 */
export const canvas_text_vs_shader_name = 'canvas_text_vs';
export const canvas_text_fs_shader_name = 'canvas_text_fs';

export const canvas_text_vs_code = `
...
`;
export const canvas_text_fs_code = `
