 ...
 * boss_002_1_rtpl
 */
export const boss_002_1_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_boss_002_1_attack" : it.controller.anim_boss_002_1_attack,
          "anim_boss_002_1_die"    : it.controller.anim_boss_002_1_die,
          "anim_boss_002_1_hurt"   : it.controller.anim_boss_002_1_hurt,
          "anim_boss_002_1_idle"   : it.controller.anim_boss_002_1_idle
        },
        "aniBox"     : it.aniBoxs[0],
