 ...
 * monster_007_rtpl
 */
export const monster_007_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_007_attack" : it.controller.anim_monster_007_attack,
          "anim_monster_007_die"    : it.controller.anim_monster_007_die,
          "anim_monster_007_hurt"   : it.controller.anim_monster_007_hurt,
          "anim_monster_007_idle"   : it.controller.anim_monster_007_idle
        },
        "aniBox"     : it.aniBoxs[0],
