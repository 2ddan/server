 ...
 * monster_017_rtpl
 */
export const monster_017_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_017_attack" : it.controller.anim_monster_017_attack,
          "anim_monster_017_die"    : it.controller.anim_monster_017_die,
          "anim_monster_017_hurt"   : it.controller.anim_monster_017_hurt,
          "anim_monster_017_idle"   : it.controller.anim_monster_017_idle
        },
        "aniBox"     : it.aniBoxs[0],
