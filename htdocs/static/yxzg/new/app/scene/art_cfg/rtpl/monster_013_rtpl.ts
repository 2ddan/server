 ...
 * monster_013_rtpl
 */
export const monster_013_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_013_attack" : it.controller.anim_monster_013_attack,
          "anim_monster_013_die"    : it.controller.anim_monster_013_die,
          "anim_monster_013_hurt"   : it.controller.anim_monster_013_hurt,
          "anim_monster_013_idle"   : it.controller.anim_monster_013_idle
        },
        "aniBox"     : it.aniBoxs[0],
