 ...
 * boss_001_3_rtpl
 */
export const boss_001_3_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_boss_001_3_attack" : it.controller.anim_boss_001_3_attack,
          "anim_boss_001_3_die"    : it.controller.anim_boss_001_3_die,
          "anim_boss_001_3_hurt"   : it.controller.anim_boss_001_3_hurt,
          "anim_boss_001_3_idle"   : it.controller.anim_boss_001_3_idle
        },
        "aniBox"     : it.aniBoxs[0],
