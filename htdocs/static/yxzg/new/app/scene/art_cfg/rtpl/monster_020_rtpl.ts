 ...
 * monster_020_rtpl
 */
export const monster_020_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_020_attack" : it.controller.anim_monster_020_attack,
          "anim_monster_020_die"    : it.controller.anim_monster_020_die,
          "anim_monster_020_hurt"   : it.controller.anim_monster_020_hurt,
          "anim_monster_020_idle"   : it.controller.anim_monster_020_idle
        },
        "aniBox"     : it.aniBoxs[0],
