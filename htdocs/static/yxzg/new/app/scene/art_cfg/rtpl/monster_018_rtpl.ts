 ...
 * monster_018_rtpl
 */
export const monster_018_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_018_attack" : it.controller.anim_monster_018_attack,
          "anim_monster_018_die"    : it.controller.anim_monster_018_hurt,
          "anim_monster_018_hurt"   : it.controller.anim_monster_018_hurt,
          "anim_monster_018_idle"   : it.controller.anim_monster_018_idle
        },
        "aniBox"     : it.aniBoxs[0],
