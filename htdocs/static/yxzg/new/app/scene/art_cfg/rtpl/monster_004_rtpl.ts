 ...
 * monster_004_rtpl
 */
export const monster_004_rtpl = (it: any) => {
    let node = {
        "name" : it.names[0],
        "type" : "node",
        "transform" : {
        ...
        "animator"  : {
          "controller" : {
            "anim_monster_004_attack" : it.controller.anim_monster_004_attack,
            "anim_monster_004_die"    : it.controller.anim_monster_004_die,
            "anim_monster_004_hurt"   : it.controller.anim_monster_004_hurt,
            "anim_monster_004_idle"   : it.controller.anim_monster_004_idle
          },
          "aniBox"     : it.aniBoxs[0],
