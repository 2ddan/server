 ...
 * monster_005_rtpl
 */
export const monster_005_rtpl = (it: any) => {
    let node = {
        "name" : it.names[0],
        "type" : "node",
        "transform" : {
        ...
        "animator"  : {
          "controller" : {
            "anim_monster_005_attack" : it.controller.anim_monster_005_attack,
            "anim_monster_005_die"    : it.controller.anim_monster_005_die,
            "anim_monster_005_hurt"   : it.controller.anim_monster_005_hurt,
            "anim_monster_005_idle"   : it.controller.anim_monster_005_idle
          },
          "aniBox"     : it.aniBoxs[0],
