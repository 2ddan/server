 ...
 * monster_009_rtpl
 */
export const monster_009_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_009_attack" : it.controller.anim_monster_009_attack,
          "anim_monster_009_die"    : it.controller.anim_monster_009_die,
          "anim_monster_009_hurt"   : it.controller.anim_monster_009_hurt,
          "anim_monster_009_idle"   : it.controller.anim_monster_009_idle
        },
        "aniBox"     : it.aniBoxs[0],
