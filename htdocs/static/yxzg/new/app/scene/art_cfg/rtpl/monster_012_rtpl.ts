 ...
 * monster_012_rtpl
 */
export const monster_012_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_012_attack" : it.controller.anim_monster_012_attack,
          "anim_monster_012_die"    : it.controller.anim_monster_012_die,
          "anim_monster_012_hurt"   : it.controller.anim_monster_012_hurt,
          "anim_monster_012_idle"   : it.controller.anim_monster_012_idle
        },
        "aniBox"     : it.aniBoxs[0],
