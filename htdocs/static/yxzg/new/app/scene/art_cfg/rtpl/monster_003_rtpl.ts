 ...
 * monster_003_rtpl
 */
export const monster_003_rtpl = (it: any) => {
    let node = {
        "name" : it.names[0],
        "type" : "node",
        "transform" : {
        ...
        "animator"  : {
          "controller" : {
            "anim_monster_003_attack" : it.controller.anim_monster_003_attack,
            "anim_monster_003_die"    : it.controller.anim_monster_003_die,
            "anim_monster_003_hurt"   : it.controller.anim_monster_003_hurt,
            "anim_monster_003_idle"   : it.controller.anim_monster_003_idle
          },
          "aniBox"     : it.aniBoxs[0],
