 ...
 * monster_006
 */
export const monster_006_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_006_attack" : it.controller.anim_monster_006_attack,
          "anim_monster_006_die"    : it.controller.anim_monster_006_die,
          "anim_monster_006_hurt"   : it.controller.anim_monster_006_hurt,
          "anim_monster_006_idle"   : it.controller.anim_monster_006_idle
        },
        "aniBox"     : it.aniBoxs[0],
