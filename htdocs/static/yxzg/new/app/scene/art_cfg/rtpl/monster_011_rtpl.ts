 ...
 * monster_011_rtpl
 */
export const monster_011_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_011_attack" : it.controller.anim_monster_011_attack,
          "anim_monster_011_die"    : it.controller.anim_monster_011_die,
          "anim_monster_011_hurt"   : it.controller.anim_monster_011_hurt,
          "anim_monster_011_idle"   : it.controller.anim_monster_011_idle
        },
        "aniBox"     : it.aniBoxs[0],
