 ...
 * monster_015_rtpl
 */
export const monster_015_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_015_attack" : it.controller.anim_monster_015_attack,
          "anim_monster_015_die"    : it.controller.anim_monster_015_die,
          "anim_monster_015_hurt"   : it.controller.anim_monster_015_hurt,
          "anim_monster_015_idle"   : it.controller.anim_monster_015_idle
        },
        "aniBox"     : it.aniBoxs[0],
