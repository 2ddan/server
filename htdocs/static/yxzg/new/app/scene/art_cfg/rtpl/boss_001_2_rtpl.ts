 ...
 * boss_001_2_rtpl
 */
export const boss_001_2_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_boss_001_2_attack" : it.controller.anim_boss_001_2_attack,
          "anim_boss_001_2_die"    : it.controller.anim_boss_001_2_die,
          "anim_boss_001_2_hurt"   : it.controller.anim_boss_001_2_hurt,
          "anim_boss_001_2_idle"   : it.controller.anim_boss_001_2_idle
        },
        "aniBox"     : it.aniBoxs[0],
