 ...
 * monster_010_rtpl
 */
export const monster_010_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_010_attack" : it.controller.anim_monster_010_attack,
          "anim_monster_010_die"    : it.controller.anim_monster_010_die,
          "anim_monster_010_hurt"   : it.controller.anim_monster_010_hurt,
          "anim_monster_010_idle"   : it.controller.anim_monster_010_idle
        },
        "aniBox"     : it.aniBoxs[0],
