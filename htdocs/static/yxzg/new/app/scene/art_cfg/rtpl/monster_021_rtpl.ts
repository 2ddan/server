 ...
 * monster_021_rtpl
 */
export const monster_021_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_021_attack" : it.controller.anim_monster_021_attack,
          "anim_monster_021_die"    : it.controller.anim_monster_021_die,
          "anim_monster_021_hurt"   : it.controller.anim_monster_021_hurt,
          "anim_monster_021_idle"   : it.controller.anim_monster_021_idle
        },
        "aniBox"     : it.aniBoxs[0],
