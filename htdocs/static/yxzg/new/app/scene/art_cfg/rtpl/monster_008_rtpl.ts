 ...
 * monster_008_rtpl
 */
export const monster_008_rtpl = (it: any) => {
    let node = {
      "name" : it.names[0],
      "type" : "node",
      "transform" : {
      ...
      "animator"  : {
        "controller" : {
          "anim_monster_008_attack" : it.controller.anim_monster_008_attack,
          "anim_monster_008_die"    : it.controller.anim_monster_008_die,
          "anim_monster_008_hurt"   : it.controller.anim_monster_008_hurt,
          "anim_monster_008_idle"   : it.controller.anim_monster_008_idle
        },
        "aniBox"     : it.aniBoxs[0],
