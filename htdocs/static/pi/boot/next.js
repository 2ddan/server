...
winit.initNext = function() {
	...
	pi_modules.commonjs.exports.require(["util/html", "widget/util"], {}, function(mods, fm) {
		...
		util.loadDir(["worker/", "ui/", "components/", "util/", "examples/", "widget/", "struct/"], flags, fm, undefined, function(fileMap) {
			...
			// 提前隐藏下载资源
			// 根据是否第一次进入,加载主界面和新手所需的功能,否则加载主界面和全部功能
			// down = util.loadDir(["app/main", "app/util"], flags, fm);
			// 删除加载进度条
